...
void *withdraw(void *arg) {
	...
	//Bloqueia o mutex para garantir acesso exclusivo á conta
	pthread_mutex_lock(&mutex);
	
	if (account_balance >= amount) {
		//Se o saldo for o sufuciente, realiza o saque
...
int main() {
	...
	int amounts[NUM_THREADS] = {1000, 2000, 1500, 3000, 2500, 1800, 2300, 1600, 1400}; //Quantias a serem sacadas
